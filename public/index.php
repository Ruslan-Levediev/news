...
$router->add('/comment/add', [\App\Controllers\CommentController::class, 'add']);
$router->add('/comment/delete/{id}', [\App\Controllers\CommentController::class, 'delete']);
$router->add('/user/profile/update', [\App\Controllers\UserController::class, 'updateProfile']);
